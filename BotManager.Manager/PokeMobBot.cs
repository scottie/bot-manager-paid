...
{
	public class PokeMobBot : Generic
	{
		public PokeMobBot(ref BotInformation botInformation) : base(ref botInformation)
		{
			this.ExecutablePath = OfSupportedBots.GetInstance()["PokeMobBot"].ExecutablePath;
		}
